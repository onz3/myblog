...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post materia_url, params: { materium: { author: @materium.author, title: @materium.title } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { author: @materium.author, title: @materium.title } }
